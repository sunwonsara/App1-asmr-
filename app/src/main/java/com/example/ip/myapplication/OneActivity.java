...
public class OneActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_two); //이거 바꾸기

        urlHash = new HashMap<>();

        final Button btn7=(Button)findViewById(R.id.but_1);
    ...
    public void onClick(View v) {
        Intent intent=new Intent(OneActivity.this, ASMRVideoActivity.class);
